...
class WeatherScreen extends StatefulWidget {
  WeatherScreen({this.star2amData,this.starShortTermWeatherData, this.starCurrentWeatherData,
    this.starSuperShortWeatherData, this.starAirConditionData,
    this.starAddrData});
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  void initState(){
    ...
    updateData(widget.star2amData, widget.starShortTermWeatherData, widget.starCurrentWeatherData,
        widget.starSuperShortWeatherData, widget.starAirConditionData, widget.starAddrData
    );
  }
  ...
  void updateData(dynamic today2amData, dynamic shortTermWeatherData, dynamic currentWeatherData,
    ...
    td_icon_6 = model.getSkyIcon(td_sky_6, td_pty_6, 10, 10, '0600')!;
    td_icon_18 = model.getSkyIcon(td_sky_18, td_pty_18, 10, 10, '1800')!;
                ...
                SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween, //spaceBetween은 위젯을 시작과 끝에 배치하고 그 사이에 나머지 위젯 배치
                            children: [
                              Container(
                                child: Expanded(
                                  child: Column(
                                    ...
                                    skyDesc,                                 
                                      ...
                                      Text('최고온도 $todayTMX°C / 최저온도 $todayTMN°C',
                                        style: TextStyle(
                                            fontFamily: 'tmon',
                                            fontSize: 10.0,
                                            color: Colors.white
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: AssetImage('assets/image/microdust_inform_background2.jpg'),
                                            ...
                                            Container(
                                              child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        daysFormat.format(DateTime.now().add(Duration(days:2))),
                                                      style: TextStyle(
                                                          fontFamily: 'tmon',
                                                          fontSize: 15.0,
                                                          color: Colors.amber
                                                    ...
                                                    Text('$df_tmr_tmn°C / $df_tmr_tmx°C',
                                                      style: TextStyle(
                                                          fontFamily: 'tmon',
                                                          fontSize: 13.0,
                                                          color: Colors.black87
